...
describe("parseDeepLink", () => {
  ...
  describe("createRoute function", () => {
    ...
    it("creates swap-transaction-status route from transaction-status host", () => {
      const parsed = parseDeepLink(
        "ledgerwallet://transaction-status?swapId=swap-1&provider=lifi&redirectUrl=https%3A%2F%2Fexample.com",
      );
      const route = createRoute(parsed);
